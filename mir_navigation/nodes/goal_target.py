...
class map_navigation():
  ...
  def choose(self):
    ...
    rospy.loginfo("|'1': Goal_1: (20.0 , 11.0)")
    rospy.loginfo("|'2': Goal_2: (19.0 , 14.0) ")
    rospy.loginfo("|'3': Goal_3: (15.0 , 17.0) ")
    rospy.loginfo("|'4': Goal_4: (24.0 , 11.0) ")
  ...
  def __init__(self):
    ...
    sub_odom = rospy.Subscriber('/amcl_pose', PoseWithCovarianceStamped, self.odom_callback)
